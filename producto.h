...
class Producto {
    ...
    public:
        ...
        string getAutor(){return autor;} //Podria ser usado para filtrar por autor
        string getEditorial() {return editorial;} //Podria ser usado para filtrar por editorial
        int getYear() {return year;} //Podria ser usado para filtrar por year

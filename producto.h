...
class Producto {
    ...
    public:
        ...
        //metodos adicionales
        //bool checaDisponibilidad(string); //para este metodo usare apuntadores por lo que lo definire en el futuro
        void muestraProducto(); //para ver el objeto
};
...
class PublicacionAcademica: public Producto {
    ...
    public:
        ...
        string getCitations();
        //metodos adicionales
        //bool checaDisponibilidad(string);

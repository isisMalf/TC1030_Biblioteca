...
int main() {
    ...
    biblio1.prestamo("Corte de rosas");
    biblio1.devolucion("Corte de rosas", &persona1);
    //biblio1.checaDisponibilidad("Paper on physics", &persona1);
    //biblio1.checaDisponibilidad("Diary of a kid", &persona1);
